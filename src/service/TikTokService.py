...
class TikTok:
    ...
    def account_download(self, cookie, proxies, mark, url, mode, earliest, latest):
        # 初始化请求模块
        self.init_request(cookie, mark, url, mode, earliest, latest)
    ...
    def init_request(self, cookie, mark, url, mode, earliest, latest):
